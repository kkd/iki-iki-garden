...
このwikiには「[[counterfeit-wholeness|にせの全体性 vs 本物の全体性]]」「Construction vs [[unfolding|Unfolding]]」「造化に従わない vs 造化に従う」など、二列の対比テーブルが複数登場する。これらは「AかBか」という二択を迫るものではない。

**テーブルの読み方：**
- 左列・右列はそれぞれ [[quality-of-life|生命の質]] のスペクトラムの両端を示す**地図**である
- 左列は「悪い・否定すべき」ではなく、「その方向に偏っているとき生命の質が下がる傾向を持つ」記述である
- 右列は「正解・目指すべき」ではなく、「その方向に向かうとき生命の質が高まる傾向を持つ」記述である

**目指すのはアマルガム（融合）：**

[[system-a-b-integration]] が示すように、どちらかを「選ぶ」のではなく、**両方の質を同時に保つ**ことが本来の方向である。Construction の明確な意図 × Unfolding の全体性への開き、にせの全体性への自覚 × 本物の全体性への志向——これらは対立ではなく、同時に成立する。

テーブルを見るたびに「自分はどちら側か」と測るのではなく、「今この状況で生命の質をどう高められるか」という問いとして受け取ってほしい。
