...
## System A/B を元にした関連仮説

本ページの概念を特定の領域に拡張した仮説。それぞれ独立ページとして分離している：

- **[[system-ab-brain-hypothesis|System A/B と左脳・右脳の対応仮説]]** — System A＝右脳・System B＝左脳という構造的対応。マクギルクリストの「使者が主人を乗っ取った」現代診断と接続し、amalgam 実現に「橋渡し役」が必要になる理由の深層を問う（Takeshiの仮説）
- **[[system-ab-civilizational-arc|文明史的アーク仮説]]** — 人類は一度 System B の極に触れ、そこから A+B の融合（amalgam）を果たすというプロセスを辿っているという仮説。[[shu-ha-ri|守破離]]・[[teal-organization|ティール発達段階]]と同型（Takeshiの仮説）

---

## 関連ページ

- [[system-ab-brain-hypothesis]] — System A/B × 左脳・右脳対応仮説（Takeshi）
- [[system-ab-civilizational-arc]] — 文明史的アーク仮説（Takeshi）
- [[brain-hemispheres]] — 左脳・右脳：マクギルクリスト「主人と使者」の基盤ページ
