...
**思想的背景**：インテグラル理論（ケン・ウィルバー）の発達段階論がベース。ティール組織の色分けはチャクラの色に由来する。**成人発達理論**（ロバート・キーガン）の発達段階とも相似構造を持つ。成人発達理論の「含んで超える」という進化の原則は、[[shu-ha-ri]]（守破離）の構造とも対応する。

**日本的展開**：「自然経営（JINEN Management）」（武井浩三・天外伺朗）がティール組織の次を目指す。コンセプトマップ上では「超えた？」という疑問符付きで示される。

**スクラムとの接続**：スクラムガイド2020の "Self-management" という表記変更にはティール組織の影響が大きいと推測される。ティール組織→ホラクラシー→アジャイル・スクラムという思想的浸透の流れ。

**アジャイルとの関係**：
> 「WFとアジャイルの対立を超えて『人がイキイキと仕事をして成果を挙げられるやり方』へ向かうと捉えるのがいいかもね、と思ったけど、そういうのはティール組織でもう言ってたね。」

**スモールイズビューティフル**（E.F.シューマッハー）との接続：
