...
プロポーザル主題。[[felt-state-pattern]]（FSP）・[[nvc]]・[[mental-model]] を経由した、人間中心設計の先にある「人間の内側を理解する」パラダイムへの転換の提案。
...
- 『eXtreme Programmingテスト技法』— Takeshi共著時代の書籍
- 『レガシーコードからの脱却』— Scrapbox中最大12,869文字
- 『リファクタリング（第2版）』
