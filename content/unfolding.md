...
「自己が開く（展開する）」という表現は、心理学・セラピー・霊性の領域で長く使われてきた。アレグザンダーの建築・空間論的な Unfolding と、これらの自己展開論的 Unfolding は、**全体（本来性）が先にあり、そこから内発的に開いていく**という構造を共有する。
...
> 紐解きはセラピーではない。**自分のメンタルモデルの構造を直視する体験を作り、その過程で抑圧されてきた感情に触れる機会を生む場**である。（→ [[mental-model]]）
