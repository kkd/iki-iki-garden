# Wiki インデックス — セカンドブレイン

全ページのカタログ。カテゴリ別・1行サマリー付き。
ingest/update のたびに更新される。
...
- [eishin-gakuen-higashino-high-school](eishin-gakuen-higashino-high-school.md) — 盈進学園東野高等学校：1985年開校、2万坪。パタン・ランゲージ世界最大規模実装。「守の最盛期に20年先んじて破の扉を開いた先駆例」
...
- [participatory-knowing](participatory-knowing.md) — 参与的認識論：対象と一体化することで初めて見えるもの。ポランニー・ゲーテ・芭蕉を貫く認識の根本原理
...
- [unfolding](unfolding.md) — 展開（Unfolding）：全体が先にあり部分はそこから生まれる生成プロセス。構築（Construction）との対比。ボーム/ボルフト/アレグザンダー三者同型
- [brain-hemispheres](brain-hemispheres.md) — 左脳・右脳（大脳半球の非対称性）：ジェインズ・ジル・ボルト・テイラー・マクギルクリスト「主人と使者」を束ねる認識論的ハブ
- [binary-thinking-vs-wholeness](binary-thinking-vs-wholeness.md) — 二元論的思考から「度合い」への転換：「生きている/死んでいる」ではなく「生命の質」で理解する

#### アレグザンダー核心概念 — 全体性・生命の質・展開
- [pattern-language](pattern-language.md) — パタン・ランゲージ：建築→ソフトウェア→組織・農・教育へと分野を超えて応用される設計言語
...
- [insect-aversion-hypothesis](insect-aversion-hypothesis.md) — 虫嫌いと自己分離の仮説：虫への嫌悪感＝自己の受け入れられない部分の投影。マルコフブランケット不透過の外界版（2022）

#### System A/B 統合と文明史的アーク
- [system-a-b-integration](system-a-b-integration.md) — System A/B の統合：感性と合理性の対立を超える統合。度合いではなく「AもBも」。おしん会議モデル
- [system-ab-brain-hypothesis](system-ab-brain-hypothesis.md) — System A/B × 左脳・右脳対応仮説：System A＝右脳・System B＝左脳。マクギルクリスト「使者が主人を乗っ取った」と接続
- [system-ab-civilizational-arc](system-ab-civilizational-arc.md) — 文明史的アーク仮説：人類は System B の極を経て A+B 融合へ。我守破離4段階・「守の最盛期に芽吹いた離の種」（パタン/パーマカルチャー/東野/日本アジャイル）

#### 学習・守破離・フレームワーク
- [shu-ha-ri](shu-ha-ri.md) — 守破離：学習段階論。通説の「順番」解釈への根本的疑問
...
- [framework-adoption-mindset](framework-adoption-mindset.md) — フレームワーク導入の意識：ScrumBut・スクラムウォーターフォールを具体例に、採用側の意識（パワーかフォース）を問う
- [negative-capability](negative-capability.md) — ネガティブ・ケイパビリティ：不確実・謎・疑念の中に留まり続ける能力。メンタルモデル・FSP・我守破離・ビオトープ管理と接続

#### 価値・原則・実践 — 3層構造と尊厳
- [values-principles-practices](values-principles-practices.md) — 価値・原則・実践：XP・パーマカルチャー・TDDに共通する3層構造。「価値駆動人生」概念を含む
- [values-ethics-dignity](values-ethics-dignity.md) — 価値・倫理・尊厳：最上位層に何を置くかの探求。価値（主観）→倫理（規範）→尊厳（存在）の階梯
- [permaculture-principles](permaculture-principles.md) — パーマカルチャーの原則：Mollison の3倫理・Holmgren の12デザイン原則。エッジ効果のXP応用を含む

#### 自己理解・人間理解・共感
- [self-understanding](self-understanding.md) — 自己理解：「自分を知る」の深さの層（表層→信念→痛み）。無意識・自動反応（生存適合OS）の構造
...
- [personality-adaptations](personality-adaptations.md) — 人格適応論：PCMの兄弟モデル。禁止令・脚本・3つのドア。「なぜそう適応したか」の発達論

#### 多様性・生命・生態
- [diversity](diversity.md) — 多様性（生物多様性と人間多様性）：両者は同型・不可分。「役に立つかどうか」で存在を測る価値観への問い直し
- [biotope-ecosystem-wholeness](biotope-ecosystem-wholeness.md) — ビオトープ・生態系と全体性：湿地ビオトープ保全活動を通じた全体性の体験。NVC・パーマカルチャーとの接続
- [nature-observation](nature-observation.md) — 自然観察：同じ場所を通年観察し続けることで「自然は変わり続ける」を概念ではなく体験する実践

#### アジャイル・ソフトウェア開発
- [xp](xp.md) — eXtreme Programming（Kent Beck）：Takeshi が最も影響を受けた体系。Balanced/Harmony/全体性としての再解釈、「忘れられたXPer」
- [agile](agile.md) — アジャイル：113ページ分のメモ。「通り過ぎた」フェーズとして総括される
- [agile-manifesto](agile-manifesto.md) — アジャイルマニフェスト：パターンランゲージの素として読む視座・XP祭り2023での「これまでと、これから」発表
- [iki-iki-manifesto](iki-iki-manifesto.md) — **生き生きマニフェスト**：XP祭り2023 提唱の更新案。多様性と共感／満たされたニーズ／巻き込みと共創／願う未来の創造。「自分への問い」として読むセクションを含む
...
#### 組織論・場の力学
- [organization-development](organization-development.md) — 組織開発・組織の生命性：「構造の変化だけで本当に実現できる？」を軸に、FSP・NVC・アレグザンダー・パーマカルチャーを接続
- [teal-organization](teal-organization.md) — ティール組織（ラルー）：インテグラル理論・成人発達理論との接続。「含んで超える」と守破離の対応
- [u-theory](u-theory.md) — U理論（シャーマー）：シュタイナー影響・Presencing = conscious participation の組織論版
- [schumacher-small-is-beautiful](schumacher-small-is-beautiful.md) — シュマッハー「スモール・イズ・ビューティフル」（1973）：組織の適正規模・仏教経済学。50年先取り
...
- [circular-society](circular-society.md) — 循環型社会・サステナビリティ：2006年「XP=持続可能性」気づきからの20年コミット
- [parkour](parkour.md) — パルクール / Méthode Naturelle：人間本来の動きの全体性。from-to構造・ベアフットランと同型の身体知実践

#### 健康と生命
- [agile-health-kaizen](agile-health-kaizen.md) — 「アジャイル式」健康カイゼンガイド（翔泳社2022, 懸田剛著）：全体性・構造保存変容を日常の健康実践に接続した集大成
- [wholeness-health](wholeness-health.md) — 健康の全体論：健康生成論・ポジティヴヘルス・食・身体運動の集成
- [science-wholeness-tension](science-wholeness-tension.md) — 科学・医学的批判と全体性知識の緊張：「疑似科学」批判とポパー・クーン・ラカトシュによる応答

#### 生きがい・意識・いまここ
- [ikigai](ikigai.md) — IKIGAI（生きがいのベン図）：2011年Ari Bancale起源の英語圏4円ベン図の出自を辿った原点調査
- [now-here](now-here.md) — いまここ（Now-Here）：フロー状態での瞬間的な一体感。自我の消失による全体性への直接的な道

### Analyses（分析）
- [analysis-epistemological-axes](analysis-epistemological-axes.md) — Takeshiの認識論的立場を貫く9軸の整理：感情の非分離・漸進的プロセス・不快受容・内発・場の固有性・度合い等。「生成的方向／発見的方向」2回路の発見
...
### Meta（メタ）
- [changes](changes.md) — 変更履歴：訪問者向けの追加・変更記録（新しい順）
