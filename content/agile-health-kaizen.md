...
2. デブサミ2022「アジャイル式いきいきヘルスマネジメント」セッション
3. 翔泳社版「アジャイル式」健康カイゼンガイド（2022年5月、福島梓と共著）
4. **AsianPLoPで論文発表**（健康カイゼンのパタン・ランゲージ論文） (未公開)
5. RubyKaigi 2025でサイン会

## アジャイル式健康カイゼンの価値と原則

アジャイル宣言を「転用」したフレームワーク。出典：スライド「[アジャイル式健康カイゼンに学ぶチームの成長のコツ](https://docswell.com/s/tkskkd/KEVL7Z-2022-06-18-160943)」（スクフェス大阪2022）および書籍本文。
...
価値→原則→実践（カイゼンパターン）という3層構造は、XPやパーマカルチャーと同型。Takeshiが繰り返し使う**分野横断的なフレームワーク生成パターン**の一例。
