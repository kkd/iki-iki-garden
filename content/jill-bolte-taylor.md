...
### [[human-attunement-system|HAS]] との構造的同型
...
## [[negative-capability|ネガティブ・ケイパビリティ]]との接続
...
[[process-communication-model|PCM]] の観点を加えると、タイプによって C2 の発火パターンが異なるため、「どんな不確実性が NC を崩すか」が個人によって違う：
