...
つまり「外来種問題」言説をそのまま社会に適用しようとすると、**二重の単純化**が起きる——生物学側の単純化と、社会への類推の誤謬。
...
1. **包摂の意識から使っているか、排除の意識から使っているか** を都度問う
2. 「**均質化への批判**」と「**純化への正当化**」を意識的に分ける
3. アナロジーが効く側面と効かない側面を区別する
4. **「人間は生物の一部」という再帰性は、人間を物として扱う論拠にはならない**——再帰性とカテゴリー還元は別物
...
- [[metaphor-thinking]] — メタファー思考：包摂／排除の方向性、安全な使い方、自然主義の誤謬
